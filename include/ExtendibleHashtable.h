...
#ifndef CSC443_PROJECT_EXTENDIBLEHASHTABLE_H
#define CSC443_PROJECT_EXTENDIBLEHASHTABLE_H
...
private:
    ...
    int minDepth;
    // Max number of bits allowed to be used to expand the number of directory entries (i.e. 2^maxDepth directory entries).
    int maxDepth;
...
#endif //CSC443_PROJECT_EXTENDIBLEHASHTABLE_H
